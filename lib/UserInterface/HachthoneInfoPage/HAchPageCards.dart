...
import 'package:first_try_signup/UserInterface/REgistrationForm/hackathon_form.dart';
...
class ApplyCard extends StatelessWidget {
  ...
  onTap: () {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => hackathone_form()), // Replace TargetPage with your desired page widget
    );
  },
  child: Container(
